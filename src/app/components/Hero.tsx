...
export default function Hero() {
  ...
  return (
    <div className='w-screen max-h-200'>
        <div className='pt-27 w-full h-200 p-10 flex justify-center items-center hover:p-0 transition-all duration-800 ease-in-out'>
            <div className='w-1/3 h-100 flex flex-col justify-center gap-1 ms-30'>
                <div className='ms-10 text-gray-800'>
                ...
                <div className='flex flex-row h-10 gap-5 ms-10'>
            ...
            <div className='w-2/3 h-100 flex justify-center'>
                    <div>
                        ...
                        <div className='absolute top-90 ps-10'>
